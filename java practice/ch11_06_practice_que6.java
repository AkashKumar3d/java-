/*
create an interface tv_remote and use it to inherit another interference smart_tv remote
 */
// create interference
interface tv_remote{
    void on_button();
...
public class ch11_06_practice_que6 {
    public static void main(String[] args) {
    tv_remote tv=new tv();// dynamic dispatched method
    tv.on_button();
    tv.change_channel();
    tv.decrease_volume();
    tv.increase_volume();
